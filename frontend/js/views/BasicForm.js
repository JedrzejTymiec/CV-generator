...
export default class extends AbstractView {
  ...
  async getHtml() {
    ...
    <div class="form-group">
      <label class="form-label" for="name-input" id="name-input-label">Name*</label>
      <input type="text" id="name-input">
      <span id="name-input-alert" class="input-alert"></span>
    </div>
    <div class="form-group">
      <label class="form-label" for="surname-input" id="surname-input-label">Surname*</label>
      <input type="text" id="surname-input">
      <span id="surname-input-alert" class="input-alert"></span>
    </div>
    <div class="form-group">
      <label class="form-label" for="proffesion-input" id="proffesion-input-label">Proffesion</label>
      <input type="text" id="proffesion-input">
      <span id="proffesion-input-alert" class="input-alert"></span>
    </div>
    <div class="form-group">
      <label class="form-label" for="about-input" id="about-input-label">About yourself*</label>
      <textarea
          id="about-input"
          maxlength="1000"
        ></textarea>
  ...
  <form id="residence-form">
    ...
    <div class="form-group">
      <label class="form-label" for="city-input" id="city-input-label">City*</label>
  ...
  <form id="contact-form">
    ...
    <div class="form-group">
      <label class="form-label" for="phone-input" id="phone-input-label">Phone Number*</label>
    ...
    <div class="form-group">
      <label class="form-label" for="linkedin-input" id="linkedin-input-label">Linkedin link</label>
      <input type="text" id="linkedin-input">
      <span id="linkedin-input-alert" class="input-alert"></span>
    </div>
    <div class="form-group">
      <label class="form-label" for="github-input" id="github-input-label">Github link</label>
